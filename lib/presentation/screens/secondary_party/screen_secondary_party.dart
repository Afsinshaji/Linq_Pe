...
class SecondaryPartyScreen extends StatelessWidget {
  const SecondaryPartyScreen(
      {super.key,
      required this.secondaryTransactionDTO,
      required this.primaryContactName});

  final TransactionsDTO secondaryTransactionDTO;
  ...
  Widget build(BuildContext context) {
    ...
    if (secondaryTransactionDTO.secondaryTransaction != null &&
      ...
      transactionList = secondaryTransactionDTO.secondaryTransaction!;
    }
                ...
                children: [
                          ...
                          Navigator.push(
                              ...
                              CupertinoPageRoute(
                                builder: (context) => AddAmountScreen(
                                  ...
                                  primaryPartyName: primaryContactName,
                                ),
                              ));
                        },
                  ...
                  BlocBuilder<TransactionsBloc, TransactionsState>(
                    builder: (context, state) {
                      String received =
                          secondaryTransactionDTO.recievedAmt.toString();
                      String balance =
                          secondaryTransactionDTO.balanceAmt.toString();
                      String payed =
                          secondaryTransactionDTO.payedAmt.toString();
              ...
              itemBuilder: (context, index) {
                ...
                if (transactionList[index].isPayed) {
                  ...
                  if (transactionList[index].fromContactId == 'You') {
                    ...
                    if (transactionList[index].toContactId == 'You') {
                      transaction = 'You received from ${contact.displayName}';
                    } else {
                      toName = contactList
                          .firstWhere((element) =>
                              element.contactId ==
