                ...
                return BlocBuilder<ContactsBloc, ContactsState>(
                  builder: (context, state) {
                    ...
                    if (isRepay == true &&
                      ...
                      if (rollingIndex >= 0) {
                        payBackAccountList =
                            rollingAccountList[rollingIndex].payBackAccountList;
                      }
                                ...
                                onChanged: (value) {
                                  ...
                                  if (value is DropDownValueModel) {
                                    ...
                                    if (isRepay == true &&
                                      ...
                                      addrepayTotalAmount(payBack.payBackAmount,ref);
                                    }
                                ...
                                dropDownList: List.generate(
                                  ...
                                  (index) {
                                    ...
                                    if (isRepay == true &&
                                      ...
                                      final primaryIndex = dataList.indexWhere(
                                          (element) =>
                                              payBackAccountList[index]
                                                  .splittedPrimaryAccountId ==
                                              element.contactId);
                                      final splittedIndex = dataList.indexWhere(
                                          (element) =>
                                              payBackAccountList[index]
                                                  .splittingAccountId ==
                                              element.contactId);
                                      if (primaryIndex >= 0) {
                                        primaryName =
                                            dataList[primaryIndex].displayName;
                                      }
                                      if (splittedIndex >= 0) {
                                        splittedName =
                                            dataList[splittedIndex].displayName;
                                      }
                                    }
