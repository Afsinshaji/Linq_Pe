...
class ViewRollingScreen extends StatefulWidget {
  const ViewRollingScreen({
    super.key,
    required this.contact,
    required this.rollingAccount,
  });
  final ContactsDTO contact;
  final RollingAccountsDTO rollingAccount;

  @override
  State<ViewRollingScreen> createState() => _ViewRollingScreenState();
}

class _ViewRollingScreenState extends State<ViewRollingScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    String received = widget.rollingAccount.recievedRollingAmt.toString();
      ...
      body: SafeArea(
        ...
        child: BlocBuilder<ContactsBloc, ContactsState>(
          builder: (context, contactstate) {
            ...
            transactionList = widget.rollingAccount.transactionList ?? [];
